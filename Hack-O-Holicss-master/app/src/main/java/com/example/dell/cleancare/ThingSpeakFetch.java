...
public class ThingSpeakFetch extends AsyncTask<Void,Void,Void> {
    ...
    public ThingSpeakFetch() {}

    public ThingSpeakFetch(MeterFragment updateReadings) {
    ...
    protected Void doInBackground(Void... voids) {
        try{
            URL url  = new URL("https://api.thingspeak.com/channels/704326/feeds.json?api_key=TNUP7EXN95VGAD9W");
